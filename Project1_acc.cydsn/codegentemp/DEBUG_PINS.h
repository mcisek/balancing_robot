...
/* Unconfigured pins */
#define DEBUG_REMOVE_RX_WAKE_SDA_MOSI_PIN  (1u)
#define DEBUG_REMOVE_RX_SDA_MOSI_PIN      (1u)
#define DEBUG_REMOVE_TX_SCL_MISO_PIN      (1u)
...
/* Unconfigured pins */
#define DEBUG_RX_WAKE_SDA_MOSI_PIN (0u == DEBUG_REMOVE_RX_WAKE_SDA_MOSI_PIN)
#define DEBUG_RX_SDA_MOSI_PIN     (0u == DEBUG_REMOVE_RX_SDA_MOSI_PIN)
#define DEBUG_TX_SCL_MISO_PIN     (0u == DEBUG_REMOVE_TX_SCL_MISO_PIN)
...
#if (DEBUG_RX_WAKE_SDA_MOSI_PIN)
    #include "DEBUG_uart_rx_wake_i2c_sda_spi_mosi.h"
#endif /* (DEBUG_RX_SDA_MOSI) */

#if (DEBUG_RX_SDA_MOSI_PIN)
    #include "DEBUG_uart_rx_i2c_sda_spi_mosi.h"
#endif /* (DEBUG_RX_SDA_MOSI) */

#if (DEBUG_TX_SCL_MISO_PIN)
    #include "DEBUG_uart_tx_i2c_scl_spi_miso.h"
#endif /* (DEBUG_TX_SCL_MISO) */
...
#if (DEBUG_RX_WAKE_SDA_MOSI_PIN)
    #define DEBUG_RX_WAKE_SDA_MOSI_HSIOM_REG \
                            (*(reg32 *) DEBUG_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define DEBUG_RX_WAKE_SDA_MOSI_HSIOM_PTR \
                            ( (reg32 *) DEBUG_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define DEBUG_RX_WAKE_SDA_MOSI_HSIOM_MASK \
                            (DEBUG_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define DEBUG_RX_WAKE_SDA_MOSI_HSIOM_POS \
                            (DEBUG_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SHIFT)

    #define DEBUG_RX_WAKE_SDA_MOSI_INTCFG_REG \
                            (*(reg32 *) DEBUG_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define DEBUG_RX_WAKE_SDA_MOSI_INTCFG_PTR \
                            ( (reg32 *) DEBUG_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define DEBUG_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS  (DEBUG_uart_rx_wake_i2c_sda_spi_mosi__SHIFT)
    #define DEBUG_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK \
                            ((uint32) DEBUG_INTCFG_TYPE_MASK << \
                                      DEBUG_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS)
#endif /* (DEBUG_RX_WAKE_SDA_MOSI_PIN) */

#if (DEBUG_RX_SDA_MOSI_PIN)
    #define DEBUG_RX_SDA_MOSI_HSIOM_REG   (*(reg32 *) DEBUG_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    #define DEBUG_RX_SDA_MOSI_HSIOM_PTR   ( (reg32 *) DEBUG_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    #define DEBUG_RX_SDA_MOSI_HSIOM_MASK  (DEBUG_uart_rx_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define DEBUG_RX_SDA_MOSI_HSIOM_POS   (DEBUG_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
#endif /* (DEBUG_RX_SDA_MOSI_PIN) */

#if (DEBUG_TX_SCL_MISO_PIN)
    #define DEBUG_TX_SCL_MISO_HSIOM_REG   (*(reg32 *) DEBUG_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    #define DEBUG_TX_SCL_MISO_HSIOM_PTR   ( (reg32 *) DEBUG_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    #define DEBUG_TX_SCL_MISO_HSIOM_MASK  (DEBUG_uart_tx_i2c_scl_spi_miso__0__HSIOM_MASK)
    #define DEBUG_TX_SCL_MISO_HSIOM_POS   (DEBUG_uart_tx_i2c_scl_spi_miso__0__HSIOM_SHIFT)
#endif /* (DEBUG_TX_SCL_MISO_PIN) */
...
#define DEBUG_RX_WAKE_SDA_MOSI_PIN_INDEX   (0u)
#define DEBUG_RX_SDA_MOSI_PIN_INDEX       (0u)
#define DEBUG_TX_SCL_MISO_PIN_INDEX       (1u)
...
#define DEBUG_RX_WAKE_SDA_MOSI_PIN_MASK ((uint32) 0x01u << DEBUG_RX_WAKE_SDA_MOSI_PIN_INDEX)
#define DEBUG_RX_SDA_MOSI_PIN_MASK     ((uint32) 0x01u << DEBUG_RX_SDA_MOSI_PIN_INDEX)
#define DEBUG_TX_SCL_MISO_PIN_MASK     ((uint32) 0x01u << DEBUG_TX_SCL_MISO_PIN_INDEX)
...
#if (DEBUG_TX_SCL_MISO_PIN)
    #define DEBUG_CHECK_TX_SCL_MISO_PIN_USED \
                (DEBUG_PIN_DM_ALG_HIZ != \
                    DEBUG_GET_P4_PIN_DM(DEBUG_uart_tx_i2c_scl_spi_miso_PC, \
                                                   DEBUG_uart_tx_i2c_scl_spi_miso_SHIFT))
#endif /* (DEBUG_TX_SCL_MISO_PIN) */
...
#elif (DEBUG_RX_WAKE_SDA_MOSI_PIN)
    #define DEBUG_SET_I2C_SCL_DR(val) \
                            DEBUG_uart_rx_wake_i2c_sda_spi_mosi_Write(val)

    #define DEBUG_SET_I2C_SCL_HSIOM_SEL(sel) \
                    DEBUG_SET_HSIOM_SEL(DEBUG_RX_WAKE_SDA_MOSI_HSIOM_REG,  \
                                                   DEBUG_RX_WAKE_SDA_MOSI_HSIOM_MASK, \
                                                   DEBUG_RX_WAKE_SDA_MOSI_HSIOM_POS,  \
                                                   (sel))

    #define DEBUG_WAIT_SCL_SET_HIGH  (0u == DEBUG_uart_rx_wake_i2c_sda_spi_mosi_Read())

#elif (DEBUG_RX_SDA_MOSI_PIN)
    #define DEBUG_SET_I2C_SCL_DR(val) \
                            DEBUG_uart_rx_i2c_sda_spi_mosi_Write(val)


    #define DEBUG_SET_I2C_SCL_HSIOM_SEL(sel) \
                            DEBUG_SET_HSIOM_SEL(DEBUG_RX_SDA_MOSI_HSIOM_REG,  \
                                                           DEBUG_RX_SDA_MOSI_HSIOM_MASK, \
                                                           DEBUG_RX_SDA_MOSI_HSIOM_POS,  \
                                                           (sel))

    #define DEBUG_WAIT_SCL_SET_HIGH  (0u == DEBUG_uart_rx_i2c_sda_spi_mosi_Read())
...
#elif (DEBUG_TX_SCL_MISO_PIN)
    #define DEBUG_WAIT_SDA_SET_HIGH  (0u == DEBUG_uart_tx_i2c_scl_spi_miso_Read())
#else
...
/* Unconfigured pins */
#define DEBUG_REMOVE_MOSI_SCL_RX_WAKE_PIN    DEBUG_REMOVE_RX_WAKE_SDA_MOSI_PIN
#define DEBUG_REMOVE_MOSI_SCL_RX_PIN         DEBUG_REMOVE_RX_SDA_MOSI_PIN
#define DEBUG_REMOVE_MISO_SDA_TX_PIN         DEBUG_REMOVE_TX_SCL_MISO_PIN
...
/* Unconfigured pins */
#define DEBUG_MOSI_SCL_RX_WAKE_PIN   DEBUG_RX_WAKE_SDA_MOSI_PIN
#define DEBUG_MOSI_SCL_RX_PIN        DEBUG_RX_SDA_MOSI_PIN
#define DEBUG_MISO_SDA_TX_PIN        DEBUG_TX_SCL_MISO_PIN
...
#define DEBUG_SS0_PIN                DEBUG_RTS_SS0_PIN
    ...
    #define DEBUG_MOSI_SCL_RX_WAKE_HSIOM_REG     DEBUG_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define DEBUG_MOSI_SCL_RX_WAKE_HSIOM_PTR     DEBUG_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define DEBUG_MOSI_SCL_RX_WAKE_HSIOM_MASK    DEBUG_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define DEBUG_MOSI_SCL_RX_WAKE_HSIOM_POS     DEBUG_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define DEBUG_MOSI_SCL_RX_WAKE_INTCFG_REG    DEBUG_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define DEBUG_MOSI_SCL_RX_WAKE_INTCFG_PTR    DEBUG_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define DEBUG_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS   DEBUG_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define DEBUG_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK  DEBUG_RX_WAKE_SDA_MOSI_HSIOM_REG
#endif /* (DEBUG_RX_WAKE_SDA_MOSI_PIN) */

#if (DEBUG_MOSI_SCL_RX_PIN)
    #define DEBUG_MOSI_SCL_RX_HSIOM_REG      DEBUG_RX_SDA_MOSI_HSIOM_REG
    #define DEBUG_MOSI_SCL_RX_HSIOM_PTR      DEBUG_RX_SDA_MOSI_HSIOM_PTR
    #define DEBUG_MOSI_SCL_RX_HSIOM_MASK     DEBUG_RX_SDA_MOSI_HSIOM_MASK
    #define DEBUG_MOSI_SCL_RX_HSIOM_POS      DEBUG_RX_SDA_MOSI_HSIOM_POS
#endif /* (DEBUG_MOSI_SCL_RX_PIN) */

#if (DEBUG_MISO_SDA_TX_PIN)
    #define DEBUG_MISO_SDA_TX_HSIOM_REG      DEBUG_TX_SCL_MISO_HSIOM_REG
    #define DEBUG_MISO_SDA_TX_HSIOM_PTR      DEBUG_TX_SCL_MISO_HSIOM_REG
    #define DEBUG_MISO_SDA_TX_HSIOM_MASK     DEBUG_TX_SCL_MISO_HSIOM_REG
    #define DEBUG_MISO_SDA_TX_HSIOM_POS      DEBUG_TX_SCL_MISO_HSIOM_REG
...
#define DEBUG_MOSI_SCL_RX_WAKE_PIN_INDEX DEBUG_RX_WAKE_SDA_MOSI_PIN_INDEX
#define DEBUG_MOSI_SCL_RX_PIN_INDEX      DEBUG_RX_SDA_MOSI_PIN_INDEX
#define DEBUG_MISO_SDA_TX_PIN_INDEX      DEBUG_TX_SCL_MISO_PIN_INDEX
...
#define DEBUG_MOSI_SCL_RX_WAKE_PIN_MASK DEBUG_RX_WAKE_SDA_MOSI_PIN_MASK
#define DEBUG_MOSI_SCL_RX_PIN_MASK      DEBUG_RX_SDA_MOSI_PIN_MASK
#define DEBUG_MISO_SDA_TX_PIN_MASK      DEBUG_TX_SCL_MISO_PIN_MASK
