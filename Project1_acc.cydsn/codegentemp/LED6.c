...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        LED6_PC =   (LED6_PC & \
                                (uint32)(~(uint32)(LED6_DRIVE_MODE_IND_MASK << (LED6_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (LED6_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
*
*  LED6_DM_STRONG     Strong Drive 
*  LED6_DM_OD_HI      Open Drain, Drives High 
*  LED6_DM_OD_LO      Open Drain, Drives Low 
*  LED6_DM_RES_UP     Resistive Pull Up 
*  LED6_DM_RES_DWN    Resistive Pull Down 
*  LED6_DM_RES_UPDWN  Resistive Pull Up/Down 
*  LED6_DM_DIG_HIZ    High Impedance Digital 
*  LED6_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
{
	SetP4PinDriveMode(LED6__0__SHIFT, mode);
}
