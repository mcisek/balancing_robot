...
#if (I2C_RX_WAKE_SDA_MOSI_PIN)
    #define I2C_RX_WAKE_SDA_MOSI_HSIOM_REG \
                            (*(reg32 *) I2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define I2C_RX_WAKE_SDA_MOSI_HSIOM_PTR \
                            ( (reg32 *) I2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define I2C_RX_WAKE_SDA_MOSI_HSIOM_MASK \
                            (I2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define I2C_RX_WAKE_SDA_MOSI_HSIOM_POS \
                            (I2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SHIFT)

    #define I2C_RX_WAKE_SDA_MOSI_INTCFG_REG \
                            (*(reg32 *) I2C_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define I2C_RX_WAKE_SDA_MOSI_INTCFG_PTR \
                            ( (reg32 *) I2C_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define I2C_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS  (I2C_uart_rx_wake_i2c_sda_spi_mosi__SHIFT)
    #define I2C_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK \
