// ======================================================================
// Project1_acc.v generated from TopDesign.cysch
// 08/02/2015 at 15:40
...
module top ;
	...
	wire [0:0] tmpOE__mpu_int_net;
	wire [0:0] tmpFB_0__mpu_int_net;
	wire [0:0] tmpIO_0__mpu_int_net;
	wire [0:0] tmpINTERRUPT_0__mpu_int_net;
	electrical [0:0] tmpSIOVREF__mpu_int_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		mpu_int
		 (.oe(tmpOE__mpu_int_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__mpu_int_net[0:0]}),
		  .io({tmpIO_0__mpu_int_net[0:0]}),
		  .siovref(tmpSIOVREF__mpu_int_net),
		  .interrupt({tmpINTERRUPT_0__mpu_int_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__mpu_int_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
