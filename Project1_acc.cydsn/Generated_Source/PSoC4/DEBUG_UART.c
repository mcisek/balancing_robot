...
void DEBUG_UartPostEnable(void)
{
    ...
    if (DEBUG_CHECK_TX_SCL_MISO_PIN_USED)
    {
        /* Set SCB UART to drive the output pin */
        DEBUG_SET_HSIOM_SEL(DEBUG_TX_SCL_MISO_HSIOM_REG, DEBUG_TX_SCL_MISO_HSIOM_MASK,
                                       DEBUG_TX_SCL_MISO_HSIOM_POS, DEBUG_HSIOM_UART_SEL);
    }
#endif /* (DEBUG_TX_SCL_MISO_PIN_PIN) */
...
void DEBUG_UartStop(void)
{
        ...
        if (DEBUG_CHECK_TX_SCL_MISO_PIN_USED)
        {
            ...
            DEBUG_SET_HSIOM_SEL(DEBUG_TX_SCL_MISO_HSIOM_REG, DEBUG_TX_SCL_MISO_HSIOM_MASK,
                                           DEBUG_TX_SCL_MISO_HSIOM_POS, DEBUG_HSIOM_GPIO_SEL);
        }
    #endif /* (DEBUG_TX_SCL_MISO_PIN_PIN) */
    ...
    void DEBUG_UartSaveConfig(void)
    {
        ...
        */
        ...
        DEBUG_UART_RX_CTRL_REG |= DEBUG_UART_RX_CTRL_SKIP_START;
            ...
            (void) DEBUG_uart_rx_wake_i2c_sda_spi_mosi_ClearInterrupt();
